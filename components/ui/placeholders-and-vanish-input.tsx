...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={cn(
        "w-full relative bg-white dark:bg-zinc-800 h-12",
        "rounded-full overflow-hidden",
        "shadow-[0_0_10px_rgba(0,0,0,0.05)]",
        "mx-auto max-w-[calc(100%-1rem)]",
        value && "bg-gray-50",
      )}
    ...
    >
      ...
      <input
        ...
        className={cn(
          ...
          "border-none dark:text-white bg-transparent text-black",
          "h-full rounded-full",
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className={cn(
                "dark:text-zinc-500 text-sm sm:text-base font-normal",
                "text-neutral-500",
                "pl-4 sm:pl-6",
                "pr-12 sm:pr-14",
                "text-left",
